...
fetch('/weather.json')
	...
	.then(data => {
		...
		insertionPoints.alerts.innerHTML = `${data.weather}<br><a href="https://forecast.weather.gov/MapClick.php?lon=-105.6988059170544&lat=37.9934785363087#.YmFqWPPMIeY">Crestone 7 Day Forecast</a>`;
