...
import { getPageNumber as getPageNumberOld, getRecipients, getTwilioSecret, saveMessageData as saveMessageDataOld, sendMessage as sendMessageOld, twilioPhoneCategories, twilioPhoneNumbers } from '@/deprecated/utils/general';
import { ActivateBody, AnnounceBody, LoginBody, PageBody, TwilioBody } from '@/deprecated/types/queue';
...
import { dateToTimeString, fNameToDate, formatPhone, parsePhone, randomString } from '@/utils/common/strings';
import { getUserPermissions } from '@/utils/common/user';
import { getPageNumber, getUserRecipients, saveMessageData, sendMessage } from '@/utils/backend/texts';
...
import { TABLE_FILE, TABLE_FILE_TRANSLATION, TABLE_SITE, TABLE_USER, typedGet, typedQuery, typedScan, typedUpdate } from '@/utils/backend/dynamoTyped';
