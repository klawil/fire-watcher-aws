...
export default function Page() {
  ...
  >
    <p className='text-center'>
      First Responder Notifications, LLC provides text-based notifications of requests for emergency
      responses. This system is intended to be used as a backup to a primary paging system (such as
      radio or pagers). We also offer the ability to host a text group for your department.
    </p>
